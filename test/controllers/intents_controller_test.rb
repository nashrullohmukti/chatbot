...
class IntentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create intent" do
    assert_difference('Intent.count') do
      post intents_url, params: { intent: { intent_id: @intent.intent_id, name: @intent.name } }
    end
  ...
  test "should update intent" do
    patch intent_url(@intent), params: { intent: { intent_id: @intent.intent_id, name: @intent.name } }
